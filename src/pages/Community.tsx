      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Button variant="outline" className="flex items-center border-[#B45309] text-[#B45309] hover:bg-[#B45309] hover:text-white px-6 py-3 rounded-xl">
              <FilterIcon className="mr-2" size={18} />
              Filter
            </Button>
            <Button variant="primary" className="flex items-center bg-[#B45309] hover:bg-[#92400E] px-6 py-3 rounded-xl">
        ...
        {activeTab === 'circles' && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {communityCircles.map(circle => <Card key={circle.id} className="community-card border-none shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-white to-[#F5F5F0] dark:from-gray-800 dark:to-gray-700 overflow-hidden">
                ...
                <CardFooter className="flex justify-between">
                  ...
                  <Button variant="primary" className="flex items-center bg-[#B45309] hover:bg-[#92400E]">
        ...
        {activeTab === 'my-circles' && <div className="flex flex-col items-center justify-center py-12">
