...
function FirstLandingPage() {
  return (
    <div className='min-h-screen bg-[#F5F5F0] dark:bg-gray-900 justify-items-center overflow-hidden'>
      ...
      >
        {/* Background/base layer - invisible */}
        <g fillOpacity={0}>
        ...
        <motion.g className="dark:fill-[#309524] fill-[#448a43]">
          ...
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 3.0, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
          ...
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 3.9, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
          ...
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 4.4, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
          ...
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 4.6, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 4.7, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
            ...
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 4.8, duration: 0.4, ease: "backOut" }}
          />
          <motion.path
