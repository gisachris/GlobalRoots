-- Chat System Integration for Existing Circles Table
-- Run this script to add chat functionality to your existing circles
...
CREATE POLICY "Circle participants viewable by mentor and participants" ON circle_participants
  FOR SELECT USING (
    user_id = auth.uid() OR 
...
CREATE POLICY "Circle mentors can manage invitations" ON invitations
  FOR ALL USING (
